        ...
        if (calcu_type) {
            ...
            if (is_valid_variables_name(code_variables_name_left)) {
                ...
                if (is_string(code_variables_name_right))
                    return !strcmp(code_variables_name_left,code_variables_name_right);
            } else
                return false;
        }
    }
                ...
                if (resolve_stat) {
                    if (!strcmp("msgbox",function_name)) {
                        ...
                        if (NULL==function_return)
                            MessageBox(NULL,function_parameters[0],function_parameters[1],*(UINT*)function_parameters[2]);
                        else
                            *function_return=MessageBox(NULL,function_parameters[0],function_parameters[1],*(UINT*)function_parameters[2]);
                    }
                    return true;
                }
            }
